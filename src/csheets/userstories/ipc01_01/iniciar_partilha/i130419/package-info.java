 ...
 * other cleansheets instances on the same LAN. Instances must appear in a 
 ...
 *  
 * <h2>2. Analysis</h2>
 * In order to make connection between customers will need to understand the 
 * communication process through the UDP/TCP protocol. It will also be necessary to 
 * understand how the application of cells to know how to send the cell contents
 * to the client. In addition to the above we must also study the operation of 
