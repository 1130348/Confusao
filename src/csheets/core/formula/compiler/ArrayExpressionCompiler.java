 ...
 */
public class ArrayExpressionCompiler implements ExpressionCompiler {
     ...
     */
    public ArrayExpressionCompiler() {
    }
...
//					case FormulaParserTokenTypes.NAME:
        ...
        if (function != null || node.getText().equalsIgnoreCase("DoWhile") || node.
            ...
            if (node.getText().equalsIgnoreCase("MINVERSE") || node.getText().equalsIgnoreCase("MMULT")) {
                ...
                JOptionPane.showMessageDialog(null, "Wrong formula...(don't use Array Formula)!", "Error", JOptionPane.INFORMATION_MESSAGE);
            }
        }
