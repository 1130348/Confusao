...
public class Workbook implements Iterable<Spreadsheet>, Serializable {
    ...
    /**
     *
     * Adds a variable to the list A validation must be performed first so that
     * there won't two variables with the same name
     *
     * @param v
     */
    ...
    /**
     *
     * Validates if a variable with that name exists in the list
     *
     * @param name
     * @return
     */
    public boolean validateVariable(String name) {
    ...
    /**
     *
     * Returns the value of variable with the given name. The validateVariable
