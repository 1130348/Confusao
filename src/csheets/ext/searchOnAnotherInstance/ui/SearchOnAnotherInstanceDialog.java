...
public class SearchOnAnotherInstanceDialog extends javax.swing.JDialog implements Observer {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Desactivated", "Activated" }));
        ...
        searchLan.setText("Search LAN");
        searchLan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchLanActionPerformed(evt);
            }
        });
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
		if (((String) jComboBox1.getSelectedItem()).
...
//		}
	...
	public void update(Observable o, Object arg) {
		if (arg instanceof NotificationEvent) {
			...
			JOptionPane.
				showMessageDialog(null, "You receive a search request for the workbook "
								  + workbookName + " by the user " + addressToSend.
								  getHostName() + ".", "Notification", JOptionPane.INFORMATION_MESSAGE);
			Workbook openWoorkbook = uiController.
				getOpenWorkbookByFileName(workbookName);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.
				getLogger(SearchOnAnotherInstanceDialog.class.getName()).
    ...
    private javax.swing.JButton searchLan;
