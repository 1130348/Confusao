 ...
 */
public class UIExtentionSearchByContent extends UIExtension {
	 ...
	 */
	public UIExtentionSearchByContent(Extension extension, UIController uiController) {
	...
	public JComponent getSideBar() {
		if (sideBar == null) {
			sideBar = new NetworkSearchContentPanel(uiController);
		}
		return sideBar;
	}
