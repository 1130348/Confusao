...
import csheets.ext.contact.ui.ContactPanel;
...
public class UIExtensionFindWorkbooks extends UIExtension {
     ...
     */
    private FindWorkbooksMenu menu;
    ...
    public JMenu getMenu() {
        if (menu == null) {
            menu = new FindWorkbooksMenu(uiController);
        }
        return menu;
    }
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new FindWorkbooksPanel(uiController);
        }
        return sideBar;
    }
