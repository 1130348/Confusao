...
public class MacrosWindowDialog extends javax.swing.JDialog {
	...
	public static synchronized MacrosWindowDialog getInstance(
		java.awt.Frame parent, boolean modal, UIController ui) {
		if (instance == null) {
			instance = new MacrosWindowDialog(parent, modal, ui);
		}
		return instance;
	}
			...
			for (String formula : macroFormulasList) {
				try {
					if (formula.charAt(0) != ';') {
						...
						value = callFunctionController.
							callMacroFunction(formula);
					}
    ...
    private void saveMacroButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveMacroButtonActionPerformed
		...
		if (MacroName != null) {
			...
			savedMacrosNames.add(MacroName);
