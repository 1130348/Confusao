 ...
 */
public abstract class ButtonsAction extends FocusOwnerAction {
	...
	/**
	 * Creates a new buttons action.
	 *
	 * @param uiController the user interface controller
	 */
	public ButtonsAction(UIController uiController) {
		this.uiController = uiController;
	}

	/**
	 * Applies the buttons to the selected cells in the focus owner table.
	 *
	...
	/**
	 * Applies the buttons to the given stylable cell
	 *
