...
/**
 * An extension of a spreadsheet, with support for action buttons, i.e. row and
 * column dimensions and cell spanning.
 *
 * @author Cristina Lops
 */
public class ButtonsSpreadsheet extends SpreadsheetExtension {
	 ...
	 */
	protected ButtonsSpreadsheet(Spreadsheet spreadsheet) {
		super(spreadsheet, ButtonsExtension.NAME);
	}
