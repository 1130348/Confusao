...
/**
 * An extension of a cell in a spreadsheet, with support for buttons, i.e. font,
 * format, alignment, color and border.
 *
 * @author Cristina Lopes
 */
public class ButtonsCell extends CellExtension {
	 ...
	 */
	ButtonsCell(Cell cell) {
		super(cell, ButtonsExtension.NAME);
		resetStyle();
	}
	...
	public void cellCopied(Cell cell, Cell source) {
		if (this.getDelegate().equals(cell)) {
			ButtonsCell stylableSource = (ButtonsCell) source.getExtension(
				ButtonsExtension.NAME);
