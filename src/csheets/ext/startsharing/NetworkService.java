...
public class NetworkService {
    ...
    public static void sendSearchRequest(InetAddress newAddress, String workbookName) {
    ...
    public static void sendSpreadSheetList(InetAddress address, Workbook workbook) {
        SearchOnAnotherInstanceClient client = new SearchOnAnotherInstanceClient();
