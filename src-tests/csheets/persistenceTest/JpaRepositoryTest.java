 ...
 */
public abstract class JpaRepositoryTest<T, ID extends Serializable> {
    ...
    /*
     * @param entity
     * @return the deleted persistent object
     */
    ...
    private class JpaPagedIterator<T> implements Iterator<T> {
        ...
        private final JpaRepositoryTest<T, ID> repository;
        private final int pageSize;
        private int currentPageNumber;
        private Iterator<T> currentPage;

        private JpaPagedIterator(JpaRepositoryTest<T, ID> repository, int pagesize) {
